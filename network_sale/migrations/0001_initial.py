    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provider_url', models.CharField(blank=True, max_length=300, null=True, verbose_name='provider url for admin panel')),
                ('products', models.ManyToManyField(related_name='products', to='network_sale.product')),
                ('provider', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='unit_provider', to='network_sale.unit', verbose_name='provider for unit')),
